"""
edited by @Susie0909 2024.09.16
...
parser.add_argument("--out_dir", type=str, default="/root/autodl-fs/0916-wgan-skeleton-recall", help="out dir to save the generated image")
...
seq_len = 6
generator = Generator(output_dim=1, input_dim=1, hidden_dim=[8, 16, 8], kernel_size=(3, 3), num_layers=3)
